...
<head>
    ...
    <script>
        function searchUser() {
            ...
            xhr.open("GET", "usrtblrmv?name=" + name, true);
...
<body>
    ...
    <form onsubmit="searchUser(); return false;">
        ...
        <input type="text" name="name" id="name" class="a" placeholder="Enter name"><br><br>
    ...
    <form action="removeuser" method="post">
        ...
        <input type="text"  class="a" name="id" id="id" placeholder="Enter Book Id"><br><br>
